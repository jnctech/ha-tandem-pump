...
| HACS-ENT1 | Medium | FIXED | feature/iss-012-hacs-compliance | Entity `unique_id` includes `entry_id` — prevents multi-entry collisions. Upgrade requires one-time entity cleanup in HA |
